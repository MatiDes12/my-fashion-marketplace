...
export async function GET(
  ...
  try {
    ...
    // Get the transaction to get the Stripe payment details
    const firstTransaction = orders[0]?.transaction?.[0];
        ...
        <body>
          <div class="receipt">
            ...
            <div class="totals-section">
              ...
              <div class="total-row">
                <span>USD Amount Charged:</span>
                <span>$${totalAmountUSD.toFixed(2)}</span>
              </div>
              <div class="total-row grand-total">
                <span>TOTAL (ETB):</span>
                <span>ETB ${totalAmountETB.toFixed(2)}</span>
              </div>
            </div>
            ...
            <div class="footer">
              ...
              <div style="margin-top: 10px; font-size: 10px;">
                Powered by <span class="stripe-logo">Stripe</span> - Secure International Payments
              </div>
            </div>
    ...
    console.error('Error generating Stripe receipt:', error);
