      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <h1 className="text-2xl font-bold text-gray-900 mb-6">Delivery System Instructions</h1>
            
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold text-gray-900 mb-3">How to Set Up Delivery</h2>
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 mb-3">Sharing Access with Delivery Persons</h2>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <code className="text-sm bg-white px-2 py-1 rounded border font-mono">https://www.avrioxshop.com/delivery/login</code>
                    </div>
                    <div>
                      <p className="text-xs text-blue-700 mb-1">Access Code:</p>
                      <p className="text-sm text-blue-800">The delivery person's phone number</p>
                    </div>
                  </div>
                </div>
                <ul className="list-disc list-inside space-y-2 text-sm text-gray-600">
                  ...
                  <li>They can access their dashboard at: <code className="bg-gray-100 px-1 rounded">https://www.avrioxshop.com/delivery/login</code></li>
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 mb-3">Assigning Deliveries</h2>
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 mb-3">Delivery Status Tracking</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-medium text-gray-900 mb-2">Status Types</h3>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-medium text-gray-900 mb-2">What Delivery Persons Can Do</h3>
                    <ul className="text-sm text-gray-600 space-y-1">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 mb-3">Example Workflow</h2>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <ol className="list-decimal list-inside space-y-2 text-sm text-gray-600">
