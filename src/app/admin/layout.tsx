...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Side Navigation - Increased z-index to 50 */}
      ...
      {/* Main Content - Added pt-16 to account for top navigation */}
      <div className="pl-64">
        <main className="p-8 pt-20"> {/* Increased top padding to account for top nav */}
          {children}
        </main>
      </div>
    </div>
