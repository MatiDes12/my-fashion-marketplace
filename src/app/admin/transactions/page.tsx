          ...
          columns={[
            ...
            },
            {
              ...
              cell: (row) => (
                <div className="text-sm font-medium text-gray-900">
                  {(() => {
                    const isStripe = row.payment_method === 'STRIPE';
                    const amountETB = formatCurrency(row.total_amount);
                    const amountUSD = convertETBToUSD(row.total_amount);
                    
                    if (isStripe) {
                      return (
                        <div>
                          <div>{amountETB}</div>
                          <div className="text-xs text-blue-600">${amountUSD} USD</div>
                        </div>
                      );
                    } else {
                      return amountETB;
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                      ...
                      <div>
                        ...
                        {selectedTransaction.payment_method === 'STRIPE' && (
                          <p className="text-lg text-blue-600 mt-1">${convertETBToUSD(selectedTransaction.total_amount)} USD</p>
                        )}
                      </div>
                      <div className="mt-2">
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
                      ...
                      <div>
                        ...
                        {selectedTransaction.payment_method === 'STRIPE' && (
                          <p className="text-lg text-green-600 mt-1">${convertETBToUSD(selectedTransaction.seller_payout_amount)} USD</p>
                        )}
                      </div>
                      <div className="mt-2">
                        <span className={`px-2 py-1 text-xs font-semibold rounded-full ${
                        ...
                        <div className="p-6 space-y-4">
                          ...
                          <div>
                            ...
                            <div>
                              ...
                              {selectedTransaction.payment_method === 'STRIPE' && (
                                <p className="text-sm text-blue-600">${convertETBToUSD(selectedTransaction.total_amount)} USD</p>
                              )}
                            </div>
                          </div>
                      </div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <div>
                                ...
                                {selectedTransaction.payment_method === 'STRIPE' && (
                                  <p className="text-sm text-green-500">${convertETBToUSD(selectedTransaction.seller_payout_amount || 0)} USD</p>
                                )}
                              </div>
                        </div>
                        </div>
                        ...
                        <div>
                          ...
                          {selectedTransaction.payment_method === 'STRIPE' && (
                            <p className="text-lg text-green-600">
                              ${convertETBToUSD(selectedTransaction.seller_payout_amount || 0)} USD
                            </p>
                          )}
                        </div>
                      </div>
