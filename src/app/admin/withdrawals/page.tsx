          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-yellow-800">
                Admin Withdrawals - Development in Progress
              </h3>
              <div className="mt-2 text-sm text-yellow-700">
                <p>
                  🚧 The withdrawals management system is currently under development. Some features may be limited or unavailable. We're working to make this fully functional soon! 🛠️
                </p>
              </div>
            </div>
          </div>
