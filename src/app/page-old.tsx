  ...
  return (
    <>
      ...
      <div className="min-h-screen relative bg-gray-900 overflow-hidden w-full">
        ...
        {/* Trending Products - Enhanced Design */}
        <AnimatedSection className="py-12" delay={0.5}>
          <ParallaxSection offset={30}>
            <div className="relative overflow-hidden">
              {/* Background gradient */}
              <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 via-pink-500/10 to-purple-500/10 rounded-3xl"></div>
              
              {/* Animated background elements */}
              <div className="absolute top-0 left-0 w-72 h-72 bg-gradient-to-br from-red-500/20 to-pink-500/20 rounded-full blur-3xl background-float"></div>
              <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-purple-500/20 to-pink-500/20 rounded-full blur-3xl background-float" style={{ animationDelay: '10s' }}></div>
              
              <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl trending-glow">
                {/* Header Section */}
                <div className="text-center mb-12">
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
                        🔥 Trending Now
                      </div>
                    </div>
                  </motion.div>
                     ...
                     className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-900 via-red-600 to-pink-600 bg-clip-text text-transparent mb-4 gradient-shift"
                   >
                     Hot Products
                   </motion.h2>
                ...
                <div className="relative">
                  ...
                  <button 
                    ...
                    className="hidden lg:flex absolute -left-8 top-1/2 -translate-y-1/2 z-20 
                      bg-white/90 backdrop-blur-sm border border-gray-200
                      rounded-full p-4 shadow-xl shadow-black/10
                      hover:bg-white hover:shadow-2xl hover:shadow-black/20
                      transition-all duration-300 group nav-button-hover"
                  >
                  ...
                  <div 
                    ref={lovedProductsRef}
                    className="relative overflow-x-auto hide-scrollbar touch-pan-x snap-x snap-mandatory px-4 lg:px-0 scroll-smooth"
                  ...
                  >
                    <div className={`
                      flex gap-6 pb-6 min-w-full
                      ${popularProducts.length <= 4 ? 'lg:justify-center' : ''}
                    `}>
                      {popularProducts.map((product, index) => (
                        <motion.div
                          key={product.id}
                          className="flex-none w-[300px] lg:w-[350px] snap-center first:ml-0"
                        ...
                        >
                                                  <Link
                          href={`/products/${product.id}`}
                          className="block relative bg-white rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-red-500/20 group border border-gray-100 product-card-hover"
                        >
                            {/* Enhanced image container */}
                            <div className="relative w-full pt-[120%] bg-gradient-to-br from-gray-50 to-gray-100">
                                 ...
                                 <Image
                                   ...
                                   priority={index < 2}
                                   quality={85}
                                   className="absolute inset-0 w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700 image-zoom"
                                   onError={(e) => {
                              ...
                              <div className="absolute top-4 left-4 z-10">
                                <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-white/95 backdrop-blur-sm text-gray-800 shadow-lg border border-white/50">
                                  {product.category}
                                </span>
                              </div>
                              ...
                              {product.flash_sale_price && (
                                <div className="absolute top-4 right-4 z-10">
                                  <div className="bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-bold px-3 py-1.5 rounded-full animate-pulse shadow-lg">
                                    🔥 SALE
                                  </div>
                                </div>
                              )}
                            ...
                            <div className="p-6">
                              {/* Title */}
                              <h3 className="text-lg font-semibold text-gray-900 line-clamp-2 group-hover:text-red-600 mb-4 transition-colors duration-300">
                                {product.title}
                              </h3>
                              ...
                              <div className="flex items-center justify-between border-t border-gray-100 pt-4">
                                ...
                                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                  <div className="bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-semibold px-3 py-1.5 rounded-full">
                                    View Details
                                  </div>
                                </div>
                              </div>
                        ...
                        onClick={() => {
                          ...
                          setCurrentLovedPage(index);
                           ...
                           ${currentLovedPage === index 
                             ? 'w-12 bg-gradient-to-r from-red-500 to-pink-500 shadow-lg shadow-red-500/50 progress-pulse'
                             : 'w-3 bg-gradient-to-r from-gray-300 to-gray-400 hover:from-red-300 hover:to-pink-300'
                             }`}
                      />
                    ))}
                  </div>
                  ...
                  <div className="lg:hidden flex justify-center mt-6">
                    <div className="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full px-6 py-3 shadow-lg">
                      <div className="text-gray-600 text-sm flex items-center gap-3">
                        ...
                        <span className="font-medium">Swipe to explore more</span>
                        <svg className="w-5 h-5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                        </svg>
                      </div>
