  ...
  const handleSubmit = async () => {
    ...
    if (selectedMethod === 'CASH') {
      try {
        ...
        // Send Telegram notifications for cash orders
        try {
          const notificationResponse = await fetch('/api/payments/cash/notify', {
            method: 'POST',
            headers: {
          ...
          if (notificationResponse.ok) {
            ...
            console.error('Failed to send cash payment notifications');
          }
